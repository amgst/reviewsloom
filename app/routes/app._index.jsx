  ...
  return (
    <Page>
      ...
      <div className="reviewloom-shell">
        <div className="reviewloom-intro"><div><Text as="p" variant="bodyMd" tone="subdued">Your store's quiet proof</Text><Text as="h1" variant="headingXl">Reviews that feel human.</Text></div><Button url="/app/requests">Send a review request</Button></div>
